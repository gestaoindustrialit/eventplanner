        ...
        <aside class="sidebar text-white p-3 d-none d-lg-flex flex-column">
            ...
            <nav class="nav flex-column gap-1 sidebar-nav">
                <?php if (isAdmin()): ?>
                    ...
                    <a class="nav-link text-white sidebar-nav-link <?= $isActiveLink('blogpost') ? 'active' : '' ?>" href="<?= BASE_URL ?>?controller=blogpost&action=index"><i class="bi bi-journal-richtext"></i><span>Blog</span></a>

...
class Checklist
{
    ...
    {
        $this->db->exec('CREATE TABLE IF NOT EXISTS checklist_templates (
        ...
        $this->db->exec('CREATE TABLE IF NOT EXISTS checklist_template_fields (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        $this->db->exec('CREATE TABLE IF NOT EXISTS event_checklists (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        $this->db->exec('CREATE TABLE IF NOT EXISTS event_checklist_items (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
